...
Verlet_adaptive::Verlet_adaptive()
{
}
...
void Verlet_adaptive::velocityVerlet(Cluster &system, double dt_initial, double total_time)
{
...
void Verlet_adaptive::integrateVerlet(Cluster &system, double dt, int n_steps)
{
...
vector<vec3> Verlet_adaptive::mult(vector<vec3> a, double k)
{
...
vector<vec3> Verlet_adaptive::add(vector<vec3> a, vector<vec3> b)
{
    if (a.size() != b.size())
    {
...
vector<vec3> Verlet_adaptive::subtract(vector<vec3> a, vector<vec3> b)
{
    if (a.size() != b.size())
    {
        std::cout << "Error: Vectors a and b must be of equal length." << std::endl;
